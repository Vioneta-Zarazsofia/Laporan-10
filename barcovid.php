...
for($bulan = 1;$bulan < 11;$bulan++){
	$query = mysqli_query($koneksi,"SELECT sum(total_cases) AS jumlah FROM data_covid WHERE id='$bulan'");
	$row = $query->fetch_array();
	$jumlah_kasus[] = $row['jumlah'];
}

for($bulan = 1;$bulan < 11;$bulan++){
	$query = mysqli_query($koneksi,"SELECT sum(total_deaths) AS jumlah FROM data_covid WHERE id='$bulan'");
	$row = $query->fetch_array();
	$jumlah_death[] = $row['jumlah'];
}

for($bulan = 1;$bulan < 11;$bulan++){
	$query = mysqli_query($koneksi,"SELECT sum(total_recovered) AS jumlah FROM data_covid WHERE id='$bulan'");
	$row = $query->fetch_array();
	$jumlah_recover[] = $row['jumlah'];
}

for($bulan = 1;$bulan < 11;$bulan++){
	$query = mysqli_query($koneksi,"SELECT sum(active_cases) AS jumlah FROM data_covid WHERE id='$bulan'");
	$row = $query->fetch_array();
	$jumlah_acases[] = $row['jumlah'];
}

for($bulan = 1;$bulan < 11;$bulan++){
	$query = mysqli_query($koneksi,"SELECT sum(total_tests) AS jumlah FROM data_covid WHERE id='$bulan'");
	$row = $query->fetch_array();
